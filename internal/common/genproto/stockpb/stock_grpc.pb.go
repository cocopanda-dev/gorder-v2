...
type StockServiceClient interface {
	GetItems(ctx context.Context, in *GetItemRequest, opts ...grpc.CallOption) (*GetItemsResponse, error)
...
func (c *stockServiceClient) GetItems(ctx context.Context, in *GetItemRequest, opts ...grpc.CallOption) (*GetItemsResponse, error) {
...
type StockServiceServer interface {
	GetItems(context.Context, *GetItemRequest) (*GetItemsResponse, error)
...
func (UnimplementedStockServiceServer) GetItems(context.Context, *GetItemRequest) (*GetItemsResponse, error) {
...
func _StockService_GetItems_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(StockServiceServer).GetItems(ctx, req.(*GetItemRequest))
	}
